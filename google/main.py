...
class GymFitnessChatbot:
    ...
    def send_request(self, prompt):
        ...
        data = {
            ...
            "generationConfig": {
                "temperature": 0.3,  # Rendah untuk mengurangi kreativitas berlebih
                "topK": 20,
                "topP": 0.8,
...
if __name__ == "__main__":
    ...
    API_KEY = "AIzaSyC6Vgjz_d_X81cdINMqp2TATkckwIufS94"  # GANTI DENGAN API KEY ANDA
    
    # Inisialisasi chatbot
    chatbot = GymFitnessChatbot(API_KEY)
    
    # Contoh penggunaan single question
    print("=== CONTOH SINGLE QUESTION ===")
    pertanyaan = str(input("Masukkan pertanyaan: "))
    response = chatbot.chat(pertanyaan, show_quality_check=True)  # Dengan quality check
    print(response)
